...
def decompression_file(file_dir):
    z = UnZip(file_dir)
    z.main_unzip(file_dir)

if __name__ == '__main__':
    # print('第三色彩'.encode("utf8").decode('gbk'))
    decompression_file('/home/lovemefan/PycharmProjects/Plagiarism Checker/data')