...
public class Calculator {
	...
	public String gotParen(char ch, Stack stack, String src) {
	...
	public String gotOper1(char ch, Stack stack, String src, int n) {
	...
	public String gotOper2(char ch, Stack stack, String src) {
	...
	public int Calculate(String temp, Stack stack, int flag) {
